				...
				<div class="col-12">
					<div class="card">
						<div class="card-header" style="width:100%">
							...
							<div class="col-md-2 col-md-offset-7" id="postAddAndDeleteDiv"><button class="btn  btn-danger btn-sm" type="button" onclick="DELETE_POST()">删除</button></div>
						</div>
						<div class="card-body">
								...
								<div class="row">
									<div class="col-sm-12">
										<table id="example2" class="table table-bordered table-hover dataTable" role="grid">
											...
											<tbody id="POST_LIST_TBODY_ID"><tr bgcolor="#FFFFFF">		<td align="center" width="20">			<input name="DELETE_CHECK_NAME" type="checkbox" value="e4f94bf452d9483aaa11972e6cc4d59d">		</td>		<td valign="center" align="center" width="30">			<a href="" onclick="EDIT_USER('e4f94bf452d9483aaa11972e6cc4d59d','sjm','0','18','sjm@163.com','0'); return false;">sjm</a> 		</td>		<td valign="center" align="center" width="30">18		</td>		<td valign="center" align="center" width="110">男		</td>		<td valign="center" align="center" width="110">2019-03-12 12:46:38		</td>		<td valign="center" align="center" width="100">2019-03-18 23:08:18		</td>		<td valign="center" align="center" width="100">普通用户		</td></tr></tbody>
											<tfoot></tfoot>
										</table>
									</div>
								</div>
	        ...
	        <div class="form-horizontal">
	             ...
	             <div class="card-body">
						 ...
						 <div class="form-group">
				        	...
				        	<div class="col-sm-10" >
				        		<input id="password" name="password" value="" class="form-control" style="width:900px"  type="password" maxlength="6" placeholder="请输入密码(可选，不填写将保持原有密码)"  >
				        	</div>
				         </div>
					        ...
					        <div class="form-group">
					        	...
					        	<div class="col-sm-10" >
					        		...
					        		<select id="regsex" name="regxex" class="form-control" style="width:900px" >
					        ...
					        <div class="form-group">
					        	...
					        	<div class="col-sm-10" >
					        		<select id="regAge" name="regAge" class="form-control" style="width:900px" >
					         ...
					         <div class="form-group">
					        	...
					        	<div class="col-sm-10" >
					        		<input id="regEmial" name="regEmial" value="" class="form-control" style="width:900px" type="text" placeholder="请输入邮箱地址"  >
					        	</div>
					        </div>
					        ...
					        <div class="form-group">
					        	...
					        	<div class="col-sm-10" >
					        		<select id="admin" name="admin" class="form-control" style="width:900px" >
			             ...
			             <div class="card-footer col-md-3 col-md-offset-4" style="width:100%"align="center">
			               <button type="button" class="btn btn-info" onclick="editUserCheck()">修改</button>
